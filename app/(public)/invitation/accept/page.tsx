  ...
  return (
    <section className="h-full flex justify-center items-center p-10">
      {invitationState === "loading" && (
        <div className="py-8 px-12 min-h-50 h-full max-h-70 min-w-50 w-full max-w-130 flex flex-col gap-4 justify-center items-center rounded-lg text-center border border-border-secondary bg-surface-primary">
          <LoadingSpinner />
